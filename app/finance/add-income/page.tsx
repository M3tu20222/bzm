...
export default function AddIncome() {
  return (
    <div className="min-h-screen bg-gray-900 text-cyan-400 p-8">
      ...
      <h1 className="text-3xl font-bold mb-8 text-center text-cyan-300 animate-pulse">Yeni Gelir Ekle</h1>
      ...
      <form className="max-w-md mx-auto bg-gray-800 p-8 rounded-lg shadow">
        ...
        <div className="mb-6">
          ...
          >
            ...
            <option value="Devlet Desteği">Devlet Desteği</option>
        ...
        <button
          type="submit"
          className="w-full bg-green-600 text-white rounded px-4 py-2 hover:bg-green-700 transition-colors duration-300"
        >
          Gelir Ekle
        </button>
      </form>
