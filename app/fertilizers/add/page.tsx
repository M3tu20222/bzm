...
export default function AddFertilizer() {
  return (
    <div className="min-h-screen bg-gray-900 text-cyan-400 p-8">
      <Link href="/fertilizers" className="inline-flex items-center text-cyan-400 hover:text-cyan-300 mb-8">
        <ArrowLeftIcon className="h-5 w-5 mr-2" />
        Geri Dön
      </Link>

      <h1 className="text-3xl font-bold mb-8 text-center text-cyan-300 animate-pulse">Yeni Gübre Ekle</h1>
      ...
      <form className="max-w-md mx-auto bg-gray-800 p-8 rounded-lg shadow">
        ...
        <div className="mb-6">
          <label htmlFor="nutrientContent" className="block text-cyan-300 mb-2">
            Besin İçeriği
          </label>
          <input
            type="text"
        ...
        <div className="mb-6">
          <label htmlFor="applicationRate" className="block text-cyan-300 mb-2">
            Uygulama Oranı
          </label>
          <input
            type="text"
